...
object ReaderMappingHelper {
    ...
    fun calculateGlobalPageNumber(
        ...
        if (pageCountCache != null && currentChapter != null) {
            ...
            if (chapterRange != null) {
                ...
                return (chapterRange.startPage + pageIndexInChapter + 1).coerceIn(1, pageCountCache.totalPages)
            }
        }
    ...
    fun buildPageInfoText(
        ...
        return when {
            readerInfo.paginationState.isCalculating && totalPages > 0 -> "$currentGlobalPage / $totalPages (计算中...)"
            readerInfo.paginationState.isCalculating -> "页数计算中..."
