...
- 截至 `2026-03-23`，由于当前模块图仍明显偏浅，`core-bridge / feature-book / feature-login / feature-reader` 尚未落地，`feature-home / feature-search / feature-rn-host` 也仍停留在最小切口，当前阶段口径已重新切回 `Phase 5 = in_progress`。
