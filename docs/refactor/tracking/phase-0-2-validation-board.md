...
| V1-07 | Phase 1 | WebView 安全策略代码与文档一致 | 域名、SSL、外链、mixed content 规则明确 | `android/app/src/main/java/com/novel/page/welfare/component/WebViewComponent.kt`, `android/app/src/main/java/com/novel/page/welfare/utils/WelfareWebSecurityConfig.kt`, `android/app/src/main/java/com/novel/page/welfare/WelfarePage.kt`, `android/app/src/main/java/com/novel/page/welfare/viewmodel/WelfareMvi.kt`, `android/app/src/main/res/xml/network_security_config.xml`, `android/app/build.gradle` | 已将福利页默认测试页切换为 `https://www.bing.com/`，并补充 `bing.com/www.bing.com/cn.bing.com` 白名单；可用于后续更稳定的真机运行验证 | in_progress | yellow | 待指定 | 待指定 | 2026-03-15 |
