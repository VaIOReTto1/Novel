...
| V0-03 | Phase 0 | 基线数据可复现 | 指标、设备、环境、轮次记录完整 | `docs/refactor/phase-0/device-matrix-and-measurement-protocol.md`, `docs/refactor/phase-0/baseline-snapshot.md`, `docs/refactor/phase-0/dynamic-baseline-run-2026-03-14.md`, `docs/refactor/evidence/profile-page-current-2026-03-15.png` | 已建立设备矩阵、静态基线，并在 `DN2101 / Android 13` 上完成冷启动、首页滚动、本地构建时长、阅读器正文翻页，以及“我的”页视觉/滚动首轮动态采样；RN `profile/settings` 调试路由复验仍白屏，因此 RN 首开动态基线尚未闭环 | in_progress | yellow | 待指定 | 待指定 | 2026-03-15 |
