...
| V1-07 | Phase 1 | WebView 安全策略代码与文档一致 | 域名、SSL、外链、mixed content 规则明确 | `android/app/src/main/java/com/novel/page/welfare/component/WebViewComponent.kt`, `android/app/src/main/java/com/novel/page/welfare/utils/WelfareWebSecurityConfig.kt`, `android/app/src/main/java/com/novel/page/welfare/WelfarePage.kt`, `android/app/src/main/java/com/novel/page/welfare/viewmodel/WelfareMvi.kt`, `android/app/src/main/res/xml/network_security_config.xml` | 已启动福利页 WebView 安全收口：默认 URL 配置化、主框架白名单校验、外链改为系统浏览器、主资源 cleartext 改为白名单放行；`assembleDebug` 已通过，真机运行取证待设备恢复在线后补录 | in_progress | yellow | 待指定 | 待指定 | 2026-03-15 |
