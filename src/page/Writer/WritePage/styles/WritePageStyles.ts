...
export const createWritePageStyles = (colors: NovelColors) => {
  ...
  return StyleSheet.create({
    ...
    publishText: { color: novelDesign.color.text.inverse, fontWeight: '600' },
    editor: {
      flex: 1,
      paddingHorizontal: wp(16),
      backgroundColor: novelDesign.color.bg.surface,
    ...
    closeText: { color: novelDesign.color.text.secondary },
    ...
    volumeText: { color: novelDesign.color.text.secondary },
    ...
    toolbarBtnText: { fontSize: fp(12), color: novelDesign.color.text.primary },
    toolbarBtnTextSecondary: { fontSize: fp(12), color: novelDesign.color.text.secondary },
    ...
    modalHint: { color: novelDesign.color.text.primary, marginBottom: wp(8) },
    modalInput: {
      borderWidth: 1,
    ...
    modalCancel: { color: novelDesign.color.text.secondary, marginRight: wp(16) },
    modalOk: { color: novelDesign.color.brand.primary },
  });
};
